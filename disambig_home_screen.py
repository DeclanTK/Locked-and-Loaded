...
background_image_homescreen = PhotoImage(file="images/background_image\lalss_1080x720_3.gif")
...
def instruction():
    ...
    mess = "\n" \
           ...
           "in windowed mode and therefore may require the user to reposition\n" \
           "the current window so that they can see the entire GUI.\n" \
