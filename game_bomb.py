...
saw = PhotoImage(file='images/bomb_game_images/saw_nxn.gif')
wires = PhotoImage(file='images/bomb_game_images/ibg_1080x720.gif')
explode = PhotoImage(file='images/bomb_game_images/explosion_nxn.gif')
defused = PhotoImage(file='images/bomb_game_images/defused_nxn.gif')
win_screen = PhotoImage(file='images/bomb_game_images/win_screen_nxn.gif')
game_over = PhotoImage(file='images/bomb_game_images/game_over_nxn.gif')
